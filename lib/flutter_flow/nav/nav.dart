      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Inventory')
        ...
        FFRoute(
          name: 'custome_detail',
          path: '/customeDetail',
          builder: (context, params) => const CustomeDetailWidget(),
        ),
        FFRoute(
          name: 'InventorySales',
          path: '/inventorySales',
          builder: (context, params) => const InventorySalesWidget(),
        ),
        FFRoute(
          name: 'Cart',
          path: '/cart',
        ...
        FFRoute(
          name: 'Bill_generator',
          path: '/billGenerator',
          builder: (context, params) => const BillGeneratorWidget(),
        ),
        FFRoute(
          name: 'ProductDetail',
          path: '/productDetail',
        ...
        FFRoute(
          ...
          builder: (context, params) => EditProductWidget(
            editProductRed: params.getParam(
              'editProductRed',
              ParamType.DocumentReference,
              false,
              ['Products'],
        ...
        FFRoute(
          name: 'ToOrder',
          path: '/toOrder',
          builder: (context, params) => const ToOrderWidget(),
        )
