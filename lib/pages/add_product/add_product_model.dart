...
class AddProductModel extends FlutterFlowModel<AddProductWidget> {
  ...
  // State field(s) for product_brand widget.
  String? productBrandValue;
  FormFieldController<String>? productBrandValueController;
  // State field(s) for product_catagory widget.
  String? productCatagoryValue;
  FormFieldController<String>? productCatagoryValueController;
