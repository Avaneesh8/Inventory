...
DocumentReference? get currentUserReference =>
    loggedIn ? BusinessPartnerRecord.collection.doc(currentUser!.uid) : null;

BusinessPartnerRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : BusinessPartnerRecord.getDocument(
                  BusinessPartnerRecord.collection.doc(uid))
              .handleError((_) {}),
    )
